...
import jaangari.opensoft.iitkgp.jaankari.hotspotUtils.WifiHOTSPOTManager;
 ...
 * helper methods.
 */
public class WifiHandler extends IntentService {
    ...
    public static void startActionFoo(Context context, String param1, String param2) {
        Intent intent = new Intent(context, WifiHandler.class);
    ...
    protected void onHandleIntent(Intent intent) {
        if (intent != null) {
            Log.d("WifiHandler", "Initializing WIFI MANAGER");
